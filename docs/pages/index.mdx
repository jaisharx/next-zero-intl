...
```
Check out the full list of all the locales <ExternalLink url="https://github.com/jaisharx/next-zero-intl/blob/main/demo/components/langs.js">here.</ExternalLink>
